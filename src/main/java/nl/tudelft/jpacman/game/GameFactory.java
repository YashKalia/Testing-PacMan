...
public class GameFactory {
     ...
     * @param pointCalculator for calculating points.
     * @return a new multilevel game.
     */
    public Game createMultiLevelGame(List<Level> levels, PointCalculator pointCalculator) {
